...
public class Prefs {
    ...
    public static SortingMode getAlbumSortingMode() {
        return SortingMode.fromValue(
                getPrefs().get(Keys.ALBUM_SORTING_MODE, DefaultPrefs.ALBUM_SORTING_MODE));
    }
    ...
    public static SortingOrder getAlbumSortingOrder() {
        return SortingOrder.fromValue(
                getPrefs().get(Keys.ALBUM_SORTING_ORDER, DefaultPrefs.ALBUM_SORTING_ORDER));
    }
    ...
    public static boolean showVideos() {
        return getPrefs().get(Keys.SHOW_VIDEOS, DefaultPrefs.SHOW_VIDEOS);
    }
    ...
    public static boolean showMediaCount() {
        return getPrefs().get(Keys.SHOW_MEDIA_COUNT, DefaultPrefs.SHOW_MEDIA_COUNT);
    }
    ...
    public static boolean showAlbumPath() {
        return getPrefs().get(Keys.SHOW_ALBUM_PATH, DefaultPrefs.SHOW_ALBUM_PATH);
    }
    ...
    public static boolean showEasterEgg() {
        return getPrefs().get(Keys.SHOW_EASTER_EGG, DefaultPrefs.SHOW_EASTER_EGG);
    }
    ...
    public static boolean animationsEnabled() {
        return !getPrefs().get(Keys.ANIMATIONS_DISABLED, DefaultPrefs.ANIMATIONS_DISABLED);
    }
    ...
    public static CardViewStyle getCardStyle() {
        return CardViewStyle.fromValue(
                getPrefs().get(Keys.CARD_STYLE, DefaultPrefs.CARD_STYLE));
    }
