...
import com.wifosoft.wumbum.animations.DepthPageTransformer;
import com.wifosoft.wumbum.data.Album;
import com.wifosoft.wumbum.data.AlbumSettings;
...
import com.wifosoft.wumbum.data.filter.MediaFilter;
import com.wifosoft.wumbum.data.provider.CPHelper;
import com.wifosoft.wumbum.data.sort.MediaComparators;
import com.wifosoft.wumbum.fragments.BaseMediaFragment;
...
import com.wifosoft.wumbum.views.HackyViewPager;
...
public class SingleMediaActivity extends SharedMediaActivity implements BaseMediaFragment.MediaTapListener {
    ...
    public static final String ACTION_OPEN_ALBUM = "com.wifosoft.wumbum.intent.VIEW_ALBUM";
    public static final String ACTION_OPEN_ALBUM_LAZY = "com.wifosoft.wumbum.intent.VIEW_ALBUM_LAZY";
