...
public class SplashScreen extends SharedMediaActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.wifosoft.wumbum.R.layout.activity_splash);
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), com.wifosoft.wumbum.R.color.md_black_1000), 70));
        }
    }
    ...
    public void updateUiElements() {
        ...
        findViewById(com.wifosoft.wumbum.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
