...
import com.wifosoft.wumbum.view_holders.model.TimelineHeaderModel;
...
public class TimelineAdapter extends ThemedAdapter<ViewHolder.TimelineViewHolder> {
    ...
    public TimelineAdapter(@NonNull Context context, IActionsListener actionsListener, int timelineGridSize) {
        super(context);
