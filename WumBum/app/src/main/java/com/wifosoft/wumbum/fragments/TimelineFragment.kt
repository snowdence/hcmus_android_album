...
import com.wifosoft.wumbum.interfaces.IActionsListener
...
import com.wifosoft.wumbum.util.deleteMedia
import com.wifosoft.wumbum.util.preferences.DefaultPrefs
import com.wifosoft.wumbum.util.shareMedia
import com.wifosoft.wumbum.view_holders.GroupingMode
import com.wifosoft.wumbum.view_holders.TimelineAdapter
 ...
 */
class TimelineFragment : BaseMediaGridFragment(), IActionsListener {
    ...
    private lateinit var timelineListener: IMediaClickListener
...
//                } else {
    ...
    private fun loadAlbum() {
        ...
        QueryHelper.getMedia(context, contentAlbum)
