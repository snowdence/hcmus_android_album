...
import com.wifosoft.wumbum.views.SquareRelativeLayout;
...
public class MediaAdapter extends ThemedAdapter<MediaAdapter.ViewHolder> {
    ...
    private final IActionsListener actionsListener;

    private boolean isSelecting = false;

    public MediaAdapter(Context context, SortingMode sortingMode, SortingOrder sortingOrder, IActionsListener actionsListener) {
        super(context);
        media = new ArrayList<>();
