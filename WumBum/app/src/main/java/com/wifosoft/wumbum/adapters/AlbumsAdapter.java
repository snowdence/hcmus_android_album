...
import com.wifosoft.wumbum.sort.AlbumComparators;
...
public class AlbumsAdapter extends ThemedAdapter<AlbumsAdapter.ViewHolder> {
    ...
    private IActionsListener actionsListener;
    private boolean isSelecting;

    public AlbumsAdapter(Context context, IActionsListener actionsListener) {
        super(context);
    ...
    public void sort() {
        Collections.sort(albums, AlbumComparators.getComparator(sortingMode, sortingOrder));
    ...
    public void onBindViewHolder(final AlbumsAdapter.ViewHolder holder, int position) {
        ...
        RequestOptions options = new RequestOptions()
                ...
                .error(com.wifosoft.wumbum.R.drawable.ic_error)
    ...
    public int add(Album album) {
        int i = Collections.binarySearch(
                albums, album, AlbumComparators.getComparator(sortingMode, sortingOrder));
        if (i < 0) i = ~i;
        albums.add(i, album);
