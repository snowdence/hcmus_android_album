...
import com.wifosoft.wumbum.interfaces.IFragment
 ...
 */
abstract class BaseMediaGridFragment : BaseFragment(), IFragment, IActionsListener {

    lateinit var editModeListener: IEditModeListener

    override fun onAttach(context: Context?) {
        super.onAttach(context)
        if (context is IEditModeListener) editModeListener = context
